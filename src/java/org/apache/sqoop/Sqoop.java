...
public class Sqoop extends Configured implements Tool {
  ...
  public static String[] tableList  = null;
  ...
  public static int runTool(String [] args, Configuration conf) {
    ...
    int retVal = runSqoop(sqoop, Arrays.copyOfRange(expandedArgs, 1, expandedArgs.length));
    if (toolName.equals("list-tables")) {
        tableList = ((ListTablesTool) tool).getListTables();
    }
    return retVal;
  }
